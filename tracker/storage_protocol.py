...
class StorageBackend(Protocol):
    ...
    def save_artifact(
        self, node_id: str, obj: Any, *, kind: str = "dataframe",
        parent_state_id: str = "", parent_artifact_state_id: str = ""
    ) -> Optional[str]: ...
    ...
    def load_last_step_params(
        ...
        """Params of the nearest AnalysisStep for func_name in state_id's lineage, or None."""
        ...
